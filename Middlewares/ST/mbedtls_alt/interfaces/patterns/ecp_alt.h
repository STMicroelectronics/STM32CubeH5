/**
  ...
  * @brief   Header for ecp_alt.c module
  *
  ******************************************************************************
  * @attention
  *
...
/**
  * @brief This file provides an API for Elliptic Curves over GF(P) (ECP) based
...
/**
  ...
  *
  * @note        Alternative implementations must keep the group IDs distinct. If
