/**
  ...
  * @brief   Implementation of mbedtls_alt ECDSA module
  ******************************************************************************
  * @attention
  *
                       ...
                       int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
  ...
  d_binary = (uint8_t *) mbedtls_calloc(grp->st_order_size, sizeof(uint8_t));
  ...
  k_binary = (uint8_t *) mbedtls_calloc(grp->st_order_size, sizeof(uint8_t));
                         ...
                         const mbedtls_mpi *s)
{
  ...
  Q_binary = (uint8_t *) mbedtls_calloc((2U * grp->st_modulus_size) + 1U, sizeof(uint8_t));
  ...
  r_binary = (uint8_t *) mbedtls_calloc(grp->st_order_size, sizeof(uint8_t));
  MBEDTLS_MPI_CHK((r_binary == NULL) ? MBEDTLS_ERR_ECP_ALLOC_FAILED : 0);

  s_binary = (uint8_t *) mbedtls_calloc(grp->st_order_size, sizeof(uint8_t));
