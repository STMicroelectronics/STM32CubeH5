...
def validate_no_measurements(value, keep_going=False, strict=False):
    pass
...
def main():
    parser = argparse.ArgumentParser(
        ...
        that the signature is valid, the token contain the required
