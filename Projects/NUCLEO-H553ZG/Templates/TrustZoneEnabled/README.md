...
file is as follows:
     ...
     - TZEN=B4 
     - SECWM1_STRT=0x0  SECWM1_END=0x3F  meaning all 256 sectors of Bank1 set as secure
...
This project is targeted to run on STM32H553xx device on NUCLEO-H553ZG boards from STMicroelectronics.  
...
### <b>Directory contents</b>
      ...
      - Templates/TrustZoneEnabled/Secure/Inc/partition_stm32h553xx.h        STM32H5 Device System Configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32H553xx devices with security enabled (TZEN=B4).  
  ...
  - User Option Bytes requirement (with STM32CubeProgrammer tool)
        ...
        - SECWM1_STRT=0x0  SECWM1_END=0x3F    All 256 sectors of internal Flash Bank1 set as secure
