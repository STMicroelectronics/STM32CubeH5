/**
  ******************************************************************************
  * @file    Templates/ROT/STiROT_Appli_TrustZone/NonSecure/Src/main.c
...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
/* Configure PI9 pin as output PP */
...
int main(void)
{
 ...
 /* Configure the System clock to have a frequency of 250 MHz (PLL) */
  ...
  GPIO_Structure_Init.Pin = GPIO_PIN_15;
  GPIO_Structure_Init.Speed = GPIO_SPEED_FREQ_LOW;

  HAL_GPIO_Init(GPIOD, &GPIO_Structure_Init);
