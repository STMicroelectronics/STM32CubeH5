...
#define GPIOA_MASK_SECCFG    (GPIO_PIN_MASK & (GPIO_PIN_10 | GPIO_PIN_9  | GPIO_PIN_3  | GPIO_PIN_2  | GPIO_PIN_7  | GPIO_PIN_6 | GPIO_PIN_5 | GPIO_PIN_4 | \
...
#define GPIOC_MASK_SECCFG    (GPIO_PIN_MASK & (GPIO_PIN_1  | GPIO_PIN_12 | GPIO_PIN_11 | GPIO_PIN_10 | GPIO_PIN_9))
#define GPIOD_MASK_SECCFG    (GPIO_PIN_MASK & (GPIO_PIN_9  | GPIO_PIN_8  | GPIO_PIN_12 | GPIO_PIN_13))
