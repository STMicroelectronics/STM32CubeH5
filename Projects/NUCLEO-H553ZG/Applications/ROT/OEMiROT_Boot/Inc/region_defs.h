...
#define _SRAM1_SIZE_MAX         (0x20000) /*!< SRAM1=128 KB */
#define _SRAM2_SIZE_MAX         (0x14000) /*!< SRAM2=80 KB */
#define _SRAM3_SIZE_MAX         (0x18000) /*!< SRAM3=96 KB */

/* Flash and internal SRAMs base addresses - Non secure aliased */
#define _FLASH_BASE_NS          (0x08000000) /*!< FLASH(1 MB) base address */
#define _SRAM1_BASE_NS          (0x20000000) /*!< SRAM1(128 KB) base address */
#define _SRAM2_BASE_NS          (0x20020000) /*!< SRAM2(80 KB) base address */
#define _SRAM3_BASE_NS          (0x20034000) /*!< SRAM3(96 KB) base address */
/* Flash and internal SRAMs base addresses - Secure aliased */
#define _FLASH_BASE_S           (0x0C000000) /*!< FLASH(1 MB) base address */
#define _SRAM1_BASE_S           (0x30000000) /*!< SRAM1(128 KB) base address */
#define _SRAM2_BASE_S           (0x30020000) /*!< SRAM2(80 KB) base address */
#define _SRAM3_BASE_S           (0x30034000) /*!< SRAM3(96 KB) base address */
