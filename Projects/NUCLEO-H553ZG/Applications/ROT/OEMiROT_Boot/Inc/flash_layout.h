...
#define RSS_LIB_BASE                        (0x0FF9E000U)
#define RSS_LIB_SIZE                        (0x4000U)
#define BOOTLOADER_BASE_NS                  (0x0BFA4000U)
#define BOOTLOADER_SIZE                     (0xC000U)
#define STM32_DESCRIPTOR_BASE_NS_3          (0x0BFAE000UL)
#define STM32_DESCRIPTOR_BASE_NS_2          (0x0BFAE200UL)
#define STM32_DESCRIPTOR_BASE_NS_1          (0x0BFAE000UL)
#define RSSLIB_PFUNC_3                      (0x0BFAE068UL)
#define RSSLIB_PFUNC_2                      (0x0BFAE268UL)
#define RSSLIB_PFUNC_1                      (0x0BFAE468UL)
