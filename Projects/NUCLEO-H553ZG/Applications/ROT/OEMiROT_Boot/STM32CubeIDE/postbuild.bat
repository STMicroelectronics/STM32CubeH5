...
set s_ld_file=%appli_dir%\STM32CubeIDE\STM32H553ZGTX_FLASH.ld
set s_main="%appli_dir%\Inc\main.h"
) else (
set s_ld_file="%appli_dir%\STM32CubeIDE\Secure\STM32H553ZGTX_FLASH.ld"
set ns_ld_file="%appli_dir%\STM32CubeIDE\NonSecure\STM32H553ZGTX_FLASH.ld"
