...
### <b>Directory contents</b>
  ...
  - ROT/STiROT_Appli_TrustZone/Secure/Inc/partition_stm32h553xx.h        STM32H5xx Device System Configuration file
  ...
  - ROT/STiROT_Appli_TrustZone/EWARM/startup_stm32h553xx.s               Startup file
  - ROT/STiROT_Appli_TrustZone/Binary                                    Application firmware image (application binary + MCUBoot header and metadata)

### <b>Hardware and Software environment</b>

  - This example runs on STM32H553xx devices with security enabled (TZEN=B4).
  - This example has been tested with STMicroelectronics NUCLEO-H553ZG (MB2321)
