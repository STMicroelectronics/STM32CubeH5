...
#define FLASH_AREA_1_SIZE              0x50000   /* Non-secure app image primary slot size */
...
#define FLASH_AREA_3_OFFSET            0x74000  /* Non-secure app image secondary slot offset */

#define FLASH_AREA_3_SIZE              0x50000   /* Non-secure app image secondary slot size */
...
#define FLASH_B_SIZE                   0x80000   /* flash bank size: 512 KBytes*/

#define FLASH_TOTAL_SIZE               (FLASH_B_SIZE+FLASH_B_SIZE) /* total flash size: 1 MByte */
