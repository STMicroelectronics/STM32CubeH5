...
The application then creates 2 threads with the same priorities:
 ...
 + **AppUDPThread** (priority 10, PreemptionThreshold 10) : created with the <i>TX_DONT_START</i> flag to be started later
...
#### <b>Hardware and Software environment</b>
 ...
 - This application runs on STM32H553xx devices.
 - This application has been tested with STMicroelectronics NUCLEO-H553ZG boards Revision: MB2321-H553ZG-A01
