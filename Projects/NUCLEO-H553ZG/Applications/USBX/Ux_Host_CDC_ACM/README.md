...
- When a cdc device is plugged to STM32H553ZGTx board, a Message will be displayed on the UART HyperTerminal (STlink VCP) showing
...
- NUCLEO-H553ZG Set-up
    - Plug the USB CDC_ACM device into the NUCLEO-H553ZG board through 'Type C to A-Female' cable to the connector.
