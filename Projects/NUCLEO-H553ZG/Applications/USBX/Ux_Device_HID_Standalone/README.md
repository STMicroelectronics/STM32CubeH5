...
This application provides an example of Azure RTOS USBX stack usage on STM32H553ZGTx board,
...
When plugged to PC host, the STM32H553ZGTx must be properly enumerated as an USB HID mouse device.
During the enumeration phase, device provides host with the requested descriptors (Device, configuration, string).
Those descriptors are used by host driver to identify the device capabilities.
Once the STM32H553ZGTx USB device successfully completed the enumeration phase, the device sends a HID report after a user button press.
...
- Connect the STM32H553ZGTx board CN11 to the PC through "TYPE-C" to "Standard A" cable.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics NUCLEO-H553ZG boards revision MB2321-A01 and can be easily tailored to any other supported device and development board.
