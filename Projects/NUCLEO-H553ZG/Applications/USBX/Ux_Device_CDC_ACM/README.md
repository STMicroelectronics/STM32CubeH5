...
This application provides an example of Azure RTOS USBX stack usage on STM32H553ZGTx board, it shows how to develop USB Device communication Class "CDC_ACM" based application.
...
When plugged to PC host, the STM32H553ZGTx must be properly enumerated as an USB Serial device and an STlink Com port.
...
Those descriptors are used by host driver to identify the device capabilities. Once STM32H553ZGTx USB device successfully completed the enumeration phase,
...
RTOS, ThreadX, USBX, USBXDevice, USB_DRD, Full Speed, CDC, VCP, USART, DMA, USBPD
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-H553ZG Set-up:
    - Connect the NUCLEO-H553ZG board CN13 to the PC through "TYPE-C" to "Standard A" cable.
