...
For more details, refer to STM32H553 Wiki articles:

  - [STiRoT for STM32H5](https://wiki.st.com/stm32mcu/wiki/Security:STiRoT_for_STM32H5)
  - [How to start with STiRoT on STM32H553](https://wiki.st.com/stm32mcu/wiki/Security:How_to_start_with_STiRoT_on_STM32H553)
