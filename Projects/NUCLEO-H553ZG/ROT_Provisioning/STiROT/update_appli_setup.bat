...
set icf_tz_s_file="%appli_dir%\EWARM\Secure\stm32h553xx_flash_s.icf"
set icf_tz_ns_file="%appli_dir%\EWARM\NonSecure\stm32h553xx_flash_ns.icf"

:: CubeIDE project Appli TrustZone files
set ld_tz_s_file="%appli_dir%\STM32CubeIDE\Secure\STM32H553ZGTX_FLASH.ld"
set ld_tz_ns_file="%appli_dir%\STM32CubeIDE\NonSecure\STM32H553ZGTX_FLASH.ld"

:: KEIL project Appli TrustZone files
set sct_tz_s_file="%appli_dir%\MDK-ARM\Secure\stm32h553xx_s.sct"
set sct_tz_ns_file="%appli_dir%\MDK-ARM\NonSecure\stm32h553xx_ns.sct"

:: CubeIDE project Appli Full Secure files
set cube_appli_postbuild="%appli_dir%\STM32CubeIDE\postbuild.sh"
set ld_file="%appli_dir%\STM32CubeIDE\STM32H553ZGTX_FLASH.ld"

:: IAR project Appli Full Secure files
set iar_appli_postbuild="%appli_dir%\EWARM\postbuild.bat"
set icf_file="%appli_dir%\EWARM\stm32h553xx_flash.icf"
...
echo stm32h553xx_flash.icf successfully updated according to STiRoT_Config.obk
IF [%1] NEQ [AUTO] cmd /k
exit 0
)
...
echo stm32h553xx_flash.icf, STM32H553ZGTX_FLASH.ld and main.h successfully updated according to STiRoT_Config.obk
IF [%1] NEQ [AUTO] cmd /k
exit 0
)
