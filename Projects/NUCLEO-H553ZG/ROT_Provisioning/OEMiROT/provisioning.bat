...
set "flash_layout=%cube_fw_path%\Projects\NUCLEO-H553ZG\%oemirot_boot_path_project%\Inc\flash_layout.h"
...
if not exist %cube_fw_path%\Projects\NUCLEO-H553ZG\%oemirot_appli_path_project% (
echo =====
