...
flash_layout="$cube_fw_path/Projects/NUCLEO-H553ZG/${oemirot_boot_path_project}/Inc/flash_layout.h"
...
if [ $isGeneratedByCubeMX == "false" ]; then
  if [[ ! -d "$cube_fw_path/Projects/NUCLEO-H553ZG/$oemirot_appli_path_project" ]]; then
    echo "====="
