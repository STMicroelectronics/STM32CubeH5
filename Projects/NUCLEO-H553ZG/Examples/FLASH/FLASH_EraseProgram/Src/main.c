...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define FLASH_USER_START_ADDR   ADDR_FLASH_SECTOR_16   /* Start @ of user Flash area */
#define FLASH_USER_END_ADDR     (ADDR_FLASH_SECTOR_63 + FLASH_SECTOR_SIZE - 1)   /* End @ of user Flash area */
...
void Error_Handler(void)
{
  ...
  while(1)
  {
    /* Turn on LED3 when there is an issue during erase or program procedure */
    BSP_LED_On(LED3);
  }
