...
The WWDG timeout is set, through counter value, to 139,81 ms.
The refresh window is set in order to make user wait 52,42 ms after a wadchdog refresh,
before writing again counter. Hence the WWDG counter is refreshed each (52,42 + 1) ms in the
...
### <b>Directory contents</b>
    ...
    - WWDG/WWDG_Example/Inc/stm32h5xx_nucleo_conf.h     BSP configuration file
    - WWDG/WWDG_Example/Inc/stm32h5xx_hal_conf.h        HAL configuration file
    - WWDG/WWDG_Example/Inc/stm32h5xx_it.h              Interrupt handlers header file
    - WWDG/WWDG_Example/Inc/main.h                      Header for main.c module
    - WWDG/WWDG_Example/Src/stm32h5xx_it.c              Interrupt handlers
    - WWDG/WWDG_Example/Src/main.c                      Main program
    - WWDG/WWDG_Example/Src/stm32h5xx_hal_msp.c         HAL MSP file
    - WWDG/WWDG_Example/Src/system_stm32h5xx.c          STM32H5xx system source file
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with NUCLEO-H553ZG board and can be
