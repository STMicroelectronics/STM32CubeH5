...
This project provides a reference template for the NUCLEO-H5E5ZJ board based on the STM32Cube HAL API and the
BSP drivers that can be used to build any firmware application.


This template shows how to use the BSP drivers for the leds, user push-button and VCP COM port of the NUCLEO-H5E5ZJ
board thanks to BSP resources initialization and demonstration codes:
  ...
  - BSP Push-button: BUTTON_USER is initialized in interrupt mode and each key-press is detected through
    the corresponding EXTI13_IRQHandler(). LED_GREEN is toggled at each key press.
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32H5E5ZJTx devices.

  - This template has been tested with STMicroelectronics NUCLEO-H5E5ZJ
