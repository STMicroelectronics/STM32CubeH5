...
This application provides an example of Azure RTOS USBX stack usage on STM32H5E5xx board,
...
When plugged to PC host, the STM32H5E5xx must be properly enumerated as an USB HID mouse device.
During the enumeration phase, device provides host with the requested descriptors (Device, configuration, string).
Those descriptors are used by host driver to identify the device capabilities.
Once the STM32H5E5xx USB device successfully completed the enumeration phase, the device sends a HID report after a user button press.
...
### <b>Hardware and Software environment</b>
  ...
  - This application runs on STM32H5E5xx devices.
  - This application has been tested with STMicroelectronics NUCLEO-H5E5ZJ boards revision MB2129-C01 and can be easily tailored to any other supported device and development board.
