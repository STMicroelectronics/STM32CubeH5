...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-H5E5ZJ
...
In order to make the program work, you must do the following :
 ...
 - Run the example
 - For SYSTEM_STOP_MODE Configuration, Unplug then Plug STLINK connection to perform a power-on-reset
