...
int main(void)
{
  ...
  /* -2- Configure External line 3 (connected to PD.03 pin) in interrupt mode */
...
/* USER CODE BEGIN 4 */
/**
  * @brief  Configures EXTI line 3 (connected to PD.03 pin) in interrupt mode
  * @param  None
  * @retval None
  */
static void EXTI13_IRQHandler_Config(void)
{
  ...
  /* Enable and set line 3 Interrupt to the lowest priority */
