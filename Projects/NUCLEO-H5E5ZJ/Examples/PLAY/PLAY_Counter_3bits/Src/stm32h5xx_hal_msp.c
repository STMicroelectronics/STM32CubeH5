...
void HAL_PLAY_MspInit(HAL_PLAY_HandleTypeDef* hplay)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLAY1ClockSelection = RCC_PLAY1CLKSOURCE_PCLK3;
    ...
    PE14     ------> PLAY1_OUT14
    */
    GPIO_InitStruct.Pin = PLAY1_OUT_BIT0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_PLAY1_OUT;
    HAL_GPIO_Init(PLAY1_OUT_BIT0_GPIO_Port, &GPIO_InitStruct);
    ...
    GPIO_InitStruct.Pin = PLAY1_OUT_BIT1_Pin|PLAY1_OUT_BIT2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_PLAY1_OUT;
...
void HAL_PLAY_MspDeInit(HAL_PLAY_HandleTypeDef* hplay)
{
  if(hplay->instance==PLAY1)
  {
    ...
    PE14     ------> PLAY1_OUT14
    */
    HAL_GPIO_DeInit(PLAY1_OUT_BIT0_GPIO_Port, PLAY1_OUT_BIT0_Pin);

    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_9|PLAY1_OUT_BIT1_Pin|PLAY1_OUT_BIT2_Pin);
