...
/* USER CODE BEGIN PV */
uint16_t NumberOfDataToTransfert = 0x00;

uint32_t Tab_Tx_32[32] = {0x51525354, 0x55565758, 0x595A5B5C, 0x5D5E5F60,
...
int main(void)
{
  ...
  NumberOfDataToTransfert = 64;

  /* Begin the communication in I2S mode: Send a data from I2S2 */
  HAL_I2S_Transmit_DMA(&hi2s1, (uint16_t*)&Tab_Tx_32, NumberOfDataToTransfert);
