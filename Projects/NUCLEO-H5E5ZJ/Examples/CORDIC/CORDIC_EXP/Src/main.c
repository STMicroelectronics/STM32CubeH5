...
/**
  ******************************************************************************
  * @file    CORDIC/CORDIC_EXP/Src/main.c
...
int main(void)
{
  ...
  if (HAL_CORDIC_Calculate_IT(&hcordic, aRefValues_q1_31, aCalculatedValues_q1_31,
                               ARRAY_SIZE) != HAL_OK)
  {
    /* Processing Error */
    Error_Handler();
  ...
  /* Correct CORDIC output values: Turn on LED_GREEN */
