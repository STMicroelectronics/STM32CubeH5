## <b>DMA_DataInterleaved Example Description</b>

How to use the DMA Controller to do DMA_DataInterleaved through data handling between transferred data from the source and transfer to
the destination through the HAL API.

This project is targeted to run on STM32H5E5ZJTx devices on NUCLEO-H5E5ZJ board from STMicroelectronics.
...
buffer placed on FLASH memory to the reception buffer placed on FLASH.
...
NUCLEO-H5E5ZJ board's LED can be used to monitor the project operation status:

 - LED1(GREEN) toggle when no error detected.
 - LED2(RED) is ON when any error occurred.
...
DMA, Data Transfer, Memory to Memory, Channel, FLASH

### <b>Directory contents</b>

    - DMA/DMA_DataInterleaved/Src/main.c                    Main program
    - DMA/DMA_DataInterleaved/Src/stm32h5xx_hal_msp.c       HAL MSP file
    - DMA/DMA_DataInterleaved/Src/system_stm32h5xx.c        STM32H5xx system source file
    - DMA/DMA_DataInterleaved/Src/stm32h5xx_it.c            Interrupt handlers
    - DMA/DMA_DataInterleaved/Inc/main.h                    Main program header file
    - DMA/DMA_DataInterleaved/Inc/stm32h5xx_nucleo_conf.h   BSP Configuration file
    - DMA/DMA_DataInterleaved/Inc/stm32h5xx_hal_conf.h      HAL Configuration file
    - DMA/DMA_DataInterleaved/Inc/stm32h5xx_it.h            Interrupt handlers header file
