## <b>Receive_with_filtering_and_FIFO_Polling Example Description</b>

This example demonstrates how to configure the FDCAN peripheral to receive messages with filtering and FIFO polling on the **STM32H5E5ZJ** device.
...
- **Polling for Reception:**  
  The application polls for messages received in RX FIFO 0 using `HAL_FDCAN_GetRxFifoFillLevel()`.  
  Only messages passing the configured filters are received and processed.
...
- **Transmission and Reception:**  
  ...
  On the other board, after polling for message reception, the received payload is compared to expected data. If OK, LED1 is turned ON.
...
Connectivity, CAN/FDCAN, Polling, Filtering, FIFO, Bit rate switching, CAN Filter, MIKROE, MCP2542

### <b>Directory contents</b>

    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Inc/stm32h5xx_nucleo_conf.h     BSP configuration file
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Inc/stm32h5xx_hal_conf.h        HAL configuration file
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Inc/stm32h5xx_it.h              Interrupt handlers header file
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Inc/main.h                      Header for main.c module
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Src/stm32h5xx_it.c              Interrupt handlers
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Src/main.c                      Main program
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Src/stm32h5xx_hal_msp.c         HAL MSP module
    - FDCAN/Receive_with_filtering_and_FIFO_Polling/Src/system_stm32h5xx.c          STM32H5xx system source file
