...
HAL_StatusTypeDef MX_UART_Tx_Queue_Config(void)
{
  ...
  pNodeConfig.Init.Request = GPDMA1_REQUEST_UART7_TX;
  ...
  pNodeConfig.DstAddress = (uint32_t)&huart7.Instance->TDR;
  pNodeConfig.DataSize = 138;
...
HAL_StatusTypeDef MX_UART_Rx_Queue_Config(void)
{
  ...
  /* Set node configuration ################################################*/
  pNodeConfig.NodeType = DMA_GPDMA_LINEAR_NODE;
  pNodeConfig.Init.Request = GPDMA1_REQUEST_UART7_RX;
  pNodeConfig.Init.BlkHWRequest = DMA_BREQ_SINGLE_BURST;
  ...
  /* Set node configuration ################################################*/
  pNodeConfig.SrcAddress = (uint32_t)&huart7.Instance->RDR;
