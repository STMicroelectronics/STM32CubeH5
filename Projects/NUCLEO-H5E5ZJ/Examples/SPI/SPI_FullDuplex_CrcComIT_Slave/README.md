...
Data buffer transmission/reception with CRC between two boards via SPI using IT.
	...
	Board: NUCLEO-H5E5ZJ (embeds a STM32H5E5ZJ device)
	CLK Pin: PE.12 (D13 pin 6 on CN5 connector)
	MISO Pin: PE.13 (D12 pin 5 on CN5 connector)
	MOSI Pin: PE.14 (D11 pin 4 on CN5 connector)
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-H5E5ZJ Set-up
    - Connect Master board PE.12 (D13 pin 6 on CN5 connector) to Slave Board PE.12 (D13 pin 6 on CN5 connector)
    - Connect Master board PE.13 (D12 pin 5 on CN5 connector) to Slave Board PE.13 (D12 pin 5 on CN5 connector)
    - Connect Master board PE.14 (D11 pin 4 on CN5 connector) to Slave Board PE.14 (D11 pin 4 on CN5 connector)
