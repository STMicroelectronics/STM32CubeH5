## <b>ADC_Calibration Example Description</b>

How to use ADC_Calibration in ADC to convert a single channel at each SW start,
conversion performed using programming model: interrupt.
This example is based on the STM32H5xx ADC HAL API.

**Example configuration:**

ADC calibration is the process of adjusting the ADC to ensure its digital output accurately represents the analog input signal.
...
- At each ADC conversion: LED1(LED_GREEN) toggle once (every 1sec)
...
### <b>Directory contents</b>
    ...
    - ADC/ADC_Calibration/Inc/stm32h5xx_nucleo_conf.h BSP configuration file
    - ADC/ADC_Calibration/Inc/stm32h5xx_hal_conf.h    HAL configuration file
    - ADC/ADC_Calibration/Inc/stm32h5xx_it.h          Interrupt handlers header file
    - ADC/ADC_Calibration/Inc/main.h                  Header for main.c module
    - ADC/ADC_Calibration/Src/stm32h5xx_it.c          Interrupt handlers
    - ADC/ADC_Calibration/Src/stm32h5xx_hal_msp.c     HAL MSP module
    - ADC/ADC_Calibration/Src/main.c                  Main program
    - ADC/ADC_Calibration/Src/system_stm32h5xx.c      STM32H5xx system source file
