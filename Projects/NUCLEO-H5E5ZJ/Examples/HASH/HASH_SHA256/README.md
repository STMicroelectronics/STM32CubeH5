...
In case the SHA256 digest is computed correctly the LED3 is turned ON.  
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with a STM32H5E5ZJTx embedded on an
    NUCLEO-H5E5ZJ board and can be easily tailored to any other supported
