/**
  ******************************************************************************
  * @file    Templates/ROT/STiROT_Appli_TrustZone/Secure/Src/main.c
...
int main(void)
{
  ...
  /* in SystemInit() based on partition_STM32H533xx.h file's definitions. */
  ...
  /* !!! To boot in a secure way, STiROT has configured and activated the Memory Protection Unit
...
static void SystemIsolation_Config(void)
{
  ...
  /* of 512 bytes.                                                            */
  /* Internal SRAM3 (starting from 0x20034000) will be configured as          */
  /* fully non-secure.                                                        */
