...
set sec_water_mark=-ob SECWM1_STRT=0x0 SECWM1_END=0x1F SECWM2_STRT=0x0 SECWM2_END=0x1F

:: =============================================== Remove protections and initialize Option Bytes ===========================================
set remove_protect_init_non_secure=-ob WRPSGn1=0xff WRPSGn2=0xff HDP1_STRT=1 HDP1_END=0 HDP2_STRT=1 HDP2_END=0
set remove_protect_init_secure=-ob SECWM1_STRT=1 SECWM1_END=0 WRPSGn1=0xff WRPSGn2=0xff SECWM2_STRT=1 SECWM2_END=0 HDP1_STRT=1 HDP1_END=0 HDP2_STRT=1 HDP2_END=0 SECBOOT_LOCK=0xC3 SWAP_BANK=0 SRAM2_RST=0 SRAM2_ECC=0 NSBOOTADD=0x80000 SECBOOTADD=0xC0000 BOOT_UBE=0xB4
