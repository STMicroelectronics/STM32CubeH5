...
/**
  ******************************************************************************
  * @file   USART/USART_Communication_TxRx_DMA/Src/main.c
  * @brief  This sample code shows how to use STM32H5xx USART AND GPDMA LL API to transfer data
  *         to/from UART peripheral from/to a PC hyperTerminal application, in DMA mode.
  ******************************************************************************
  * @attention
  *
...
static void MX_USART2_UART_Init(void)
{
  ...
  */
  ...
  LL_DMA_ConfigAddresses(GPDMA1, LL_DMA_CHANNEL_1,
                         ...
                         (uint32_t)aRxBuffer);
  LL_DMA_SetBlkDataLength(GPDMA1, LL_DMA_CHANNEL_1, ubNbDataToReceive);
...
/**
  * @brief  Function called in case of error detected in GPDMA1 IT Handler
  * @param  None
  * @retval None
  */
void GPDMA1_TransferError_Callback(void)
{
  /* Disable GPDMA1 Tx Channel */
  LL_DMA_DisableChannel(GPDMA1, LL_DMA_CHANNEL_0);
