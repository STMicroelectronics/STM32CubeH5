...
/**
  ******************************************************************************
  * @file    Examples_LL/SPI/SPI_OneBoard_HalfDuplex_DMA_Init/Src/stm32h5xx_it.c
...
void GPDMA2_Channel0_IRQHandler(void)
{
  ...
  if (LL_DMA_IsActiveFlag_TC(GPDMA2,LL_DMA_CHANNEL_0))
  {
    LL_DMA_ClearFlag_TC(GPDMA2, LL_DMA_CHANNEL_0);
    /* Call function Reception complete Callback */
    GPDMA2_ReceiveComplete_Callback();
  }
  else if (LL_DMA_IsActiveFlag_DTE(GPDMA2, LL_DMA_CHANNEL_0))
  {
    /* Call Error function */
    SPI_TransferError_Callback();
  }
