...
This application provides an example of FileX stack usage on NUCLEO-H533RE board, running in standalone mode (without ThreadX). It demonstrates how to create a Fat File system on the internal SRAM memory using FileX API.
