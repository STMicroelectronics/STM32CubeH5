...
#define _SRAM3_SIZE_MAX         (0x10000) /*!< SRAM3=64 KB */
...
#define _SRAM3_BASE_NS          (0x20034000) /*!< SRAM3(64 KB) base address */
...
#define _SRAM3_BASE_S           (0x30034000) /*!< SRAM3(320 KB) base address */
