...
/* start address for the initialization values of the .preinit_array section.
defined in linker script */
.word __preinit_array_loadaddr
/* start address for the .preinit_array scetion. defined in linker script */
.word __preinit_array_start
/* end address for the .preinit_array section. defined in linker script */
.word __preinit_array_end

/* start address for the initialization values of the .init_array section.
defined in linker script */
.word __init_array_loadaddr
/* start address for the .init_array scetion. defined in linker script */
.word __init_array_start
/* end address for the .init_array section. defined in linker script */
.word __init_array_end

/* start address for the initialization values of the .fini_array section.
defined in linker script */
.word __fini_array_loadaddr
/* start address for the .fini_array scetion. defined in linker script */
.word __fini_array_start
/* end address for the .fini_array section. defined in linker script */
...
Reset_Handler:
  ...
  /* Copy the data segments initializers from flash to SRAM */
  INIT_DATA __preinit_array_start, __preinit_array_end, __preinit_array_loadaddr
  INIT_DATA __init_array_start, __init_array_end, __init_array_loadaddr
  INIT_DATA __fini_array_start, __fini_array_end, __fini_array_loadaddr
