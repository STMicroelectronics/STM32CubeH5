...
/**
  ...
  * @brief   This sample code shows how to use STM32H5xx I2C HAL API to
...
static void MX_I2C2_Init(void)
{
  ...
  hi2c2.Instance = I2C2;
  hi2c2.Init.Timing = 0x10901A4F;
  hi2c2.Init.OwnAddress1 = I2C_MASTER2_ADDRESS;
...
{
  /* Master2 Tx */
  MasterStatus2 = HAL_I2C_Master_Transmit_IT(&hi2c2, (uint16_t)I2C_ADDRESS, (uint8_t*)aTxBufferMaster2, TXBUFFERSIZE);
  if (MasterStatus2 != HAL_OK)
  {
    if ((hi2c2.State == HAL_I2C_STATE_READY) && (MasterStatus2 == HAL_BUSY))
    {
      /* Increment Multimaster Busy bus detection */
      Master2BusBusyCpt++;
    }
