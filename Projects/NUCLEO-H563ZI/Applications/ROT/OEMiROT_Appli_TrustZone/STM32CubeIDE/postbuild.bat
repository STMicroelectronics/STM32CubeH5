...
set s_code_bin="%projectdir%\Secure\%config%\NUCLEO-H563ZI_OEMiROT_Appli_TrustZone_S.bin"
set ns_code_bin="%projectdir%\NonSecure\%config%\NUCLEO-H563ZI_OEMiROT_Appli_TrustZone_NS.bin"
