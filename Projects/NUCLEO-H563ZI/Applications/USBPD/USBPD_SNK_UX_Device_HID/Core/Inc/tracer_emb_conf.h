...
#define TRACER_EMB_TX_GPIO_ENABLE_CLOCK()            LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOD)
#define TRACER_EMB_RX_GPIO                           GPIOD
#define TRACER_EMB_RX_PIN                            LL_GPIO_PIN_9
#define TRACER_EMB_RX_AF                             LL_GPIO_AF_7
#define TRACER_EMB_RX_GPIO_ENABLE_CLOCK()            LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOD)
...
#define TRACER_EMB_SET_CLK_SOURCE_USART()            /* No need for clock source selection in case of USARTUSART3 */
...
#define TRACER_EMB_TX_DMA_REQUEST                    LL_GPDMA1_REQUEST_USART3_TX
