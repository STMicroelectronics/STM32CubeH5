...
/**
  ******************************************************************************
  * @file    I3C/I3C_Controller_Private_Command_IT/Src/stm32h5xx_it.c
...
void I3C1_EV_IRQHandler(void)
{
  ...
  /* I3C Control Fifo Not Full event Check */
  if (LL_I3C_IsActiveFlag_CFNF(hi3c1.Instance))
  {
    /* Call the associated callback */
    Controller_Frame_Update_Callback();
  }
