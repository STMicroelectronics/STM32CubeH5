...
For more details, refer to STM32H563 Wiki article:

  - [Debug authentication for STM32H63](https://wiki.st.com/stm32mcu/index.php?title=Security:How_to_start_with_DA_access_on_STM32H573_and_H563-TrustZone_disabled_-_stm32mcu)