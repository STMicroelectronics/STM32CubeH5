...
- This example has been tested with STMicroelectronics NUCLEO-STM32H563ZI (MB1404)
...
For more details, refer to STM32H563 Wiki articles:

  - [OEMiRoT OEMuRoT for STM32H5](https://wiki.st.com/stm32mcu/wiki/Security:OEMiRoT_OEMuRoT_for_STM32H5)
  - [How to start with OEMiRoT on STM32H563](https://wiki.st.com/stm32mcu/wiki/Security:How_to_start_with_OEMiRoT_on_STM32H573_and_563%E2%80%93TrustZone_enabled)
