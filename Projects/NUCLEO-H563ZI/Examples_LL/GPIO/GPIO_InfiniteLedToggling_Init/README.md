...
every 250 ms. This example is based on the STM32H5xx LL API. The peripheral
...
On NUCLEO-H563ZI board this IO is connected to LED1.
...
### <b>Directory contents</b>
  ...
  - GPIO/GPIO_InfiniteLedToggling_Init/Inc/stm32h5xx_it.h          Interrupt handlers header file
  ...
  - GPIO/GPIO_InfiniteLedToggling_Init/Src/stm32h5xx_it.c          Interrupt handlers
  - GPIO/GPIO_InfiniteLedToggling_Init/Src/main.c                  Main program
  - GPIO/GPIO_InfiniteLedToggling_Init/Src/system_stm32h5xx.c      STM32H5xx system source file
