...
void SystemClock_Config(void)
{
  ...
  LL_Init1msTick(125000000);

  LL_SetSystemCoreClock(125000000);
}
...
static void MX_ADC1_Init(void)
{
  ...
  */
  ...
  DMA_InitNodeStruct.UpdateRegisters          = (LL_DMA_UPDATE_CTR1 | LL_DMA_UPDATE_CTR2 | LL_DMA_UPDATE_CBR1 | LL_DMA_UPDATE_CSAR | LL_DMA_UPDATE_CDAR | LL_DMA_UPDATE_CTR3 | LL_DMA_UPDATE_CBR2 | LL_DMA_UPDATE_CLLR);
