...
int main(void)
{
  ...
  /* Output SYSCLK  on MCO2 pin(PA.08) */
...
/* Set SYSCLK frequency to 250000000, coming from the PLL which is clocked by CSI */
 ...
 
{
    ...
    /* Set SYSCLK frequency to 250 MHz, coming from the PLL which is clocked by HSE bypass */
...
/**
  * @brief  Switch the PLL source from CSI to HSE bypass, and select the PLL as SYSCLK
  *         source.
