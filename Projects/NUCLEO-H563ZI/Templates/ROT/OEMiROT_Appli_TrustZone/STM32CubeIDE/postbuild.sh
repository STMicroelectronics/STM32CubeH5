...
s_code_bin="$project_dir/Secure/$config/NUCLEO-H563ZI_OEMiROT_Appli_TrustZone_S_Templates.bin"
ns_code_bin="$project_dir/NonSecure/$config/NUCLEO-H563ZI_OEMiROT_Appli_TrustZone_NS_Templates.bin"
