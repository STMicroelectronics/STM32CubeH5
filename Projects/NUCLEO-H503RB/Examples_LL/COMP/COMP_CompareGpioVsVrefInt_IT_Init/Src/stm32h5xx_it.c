...
/**
  ******************************************************************************
  * @file    Examples_LL/COMP/COMP_CompareGpioVsVrefInt_IT_Init/Src/stm32h5xx_it.c
...
{
  /* Disable comparator interruption */
  /* Note: Specific to comparator of this STM32 series: comparator output triggers interruption on level
