...
/**
  ...
  *          the system clock through the STM32H5xx RCC LL API.
  ******************************************************************************
  * @attention
  *
...
{
  {LL_RCC_MCO1SOURCE_PLL1Q, LL_RCC_MCO1_DIV_6},
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_SetPinPull(EXTI_PIN_GPIO_Port, EXTI_PIN_Pin, LL_GPIO_PULL_DOWN);
