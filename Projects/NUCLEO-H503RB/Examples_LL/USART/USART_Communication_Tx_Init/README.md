...
with a Timeout error code. This example is based on STM32H5xx USART LL API. Peripheral
...
### <b>Directory contents</b>
  ...
  - USART/USART_Communication_Tx_Init/Inc/stm32h5xx_it.h          Interrupt handlers header file
  ...
  - USART/USART_Communication_Tx_Init/Src/stm32h5xx_it.c          Interrupt handlers
  - USART/USART_Communication_Tx_Init/Src/main.c                  Main program
  - USART/USART_Communication_Tx_Init/Src/system_stm32h5xx.c      STM32H5xx system source file
...
### <b>Hardware and Software environment</b>
  ...
  - NUCLEO-H503RB Set-up
    ...
    - Connect STM32 MCU board USART2 TX pin (GPIO PC.06 connected to pin 2 of connector CN5)
      to PC COM port RX signal
    - Connect STM32 MCU board USART2 RX pin (GPIO PC.07 connected to pin 1 of connector CN5)
