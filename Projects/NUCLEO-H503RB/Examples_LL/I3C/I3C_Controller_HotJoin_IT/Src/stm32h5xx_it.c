...
/**
  ******************************************************************************
  * @file    I3C/I3C_Controller_HotJoin_IT/Src/stm32h5xx_it.c
...
void I3C1_EV_IRQHandler(void)
{
  ...
  /* Check Hot Join flag in EVR register */
  if (LL_I3C_IsActiveFlag_HJ(I3C1))
  {
    /* Clear Hot Join flag */
    LL_I3C_ClearFlag_HJ(I3C1);

  /* Call the corresponding callback */
    Controller_Notification_Callback();
  }
