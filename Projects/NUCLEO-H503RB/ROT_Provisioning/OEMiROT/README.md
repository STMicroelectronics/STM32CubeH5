...
- OEMiROT/keygen.bat/.sh                      Configures keys for authentication and encryption.
- OEMiROT/ob_flash_programming.bat/.sh        Programs Option bytes and firmware image download on the device.
...
- [How to start with OEMiRoT on STM32H503](https://wiki.st.com/stm32mcu/wiki/Security:How_to_start_with_OEMiRoT_on_STM32H503)
