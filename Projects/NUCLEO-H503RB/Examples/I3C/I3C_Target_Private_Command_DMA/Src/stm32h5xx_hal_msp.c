...
/**
  ******************************************************************************
  * @file    I3C/I3C_Target_Private_Command_DMA/Src/stm32h5xx_hal_msp.c
...
void HAL_I3C_MspInit(I3C_HandleTypeDef* hi3c)
{
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel0.Init.Request = GPDMA1_REQUEST_I3C1_RX;
    ...
    __HAL_LINKDMA(hi3c, hdmarx, handle_GPDMA1_Channel0);
