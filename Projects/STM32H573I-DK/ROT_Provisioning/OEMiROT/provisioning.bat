...
set "flash_layout=%cube_fw_path%\Projects\STM32H573I-DK\%oemirot_boot_path_project%\Inc\flash_layout.h"
...
if not exist %cube_fw_path%\Projects\STM32H573I-DK\%oemirot_appli_path_project% (
echo =====
