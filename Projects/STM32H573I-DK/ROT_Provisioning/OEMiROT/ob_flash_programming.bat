...
set one_code_image=rot_tz_app_sign.hex
...
echo %action%
%stm32programmercli% %connect_no_reset% -d %cube_fw_path%\Projects\STM32H573I-DK\Applications\ROT\OEMiROT_Boot\EWARM\STM32H573I-DK\Exe\project.bin %bootaddress% -v
IF !errorlevel! NEQ 0 goto :error
