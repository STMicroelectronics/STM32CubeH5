...
set appli_dir="..\..\..\Templates\ROT\OEMiROT_Appli_TrustZone"
...
set s_data_enc_sign_hex="%provisioningdir%\%bootpath%\Binary\s_data_enc_sign.hex"
set ns_data_enc_sign_hex="%provisioningdir%\%bootpath%\Binary\ns_data_enc_sign.hex"
set s_data_init_sign_hex="%provisioningdir%\%bootpath%\Binary\s_data_init_sign.hex"
set ns_data_init_sign_hex="%provisioningdir%\%bootpath%\Binary\ns_data_init_sign.hex"
