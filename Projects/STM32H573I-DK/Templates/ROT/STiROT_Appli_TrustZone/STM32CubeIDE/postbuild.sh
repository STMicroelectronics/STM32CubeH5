...
s_code_bin="$project_dir/Secure/$config/STM32H573I-DK_STiROT_Appli_TrustZone_S_Templates.bin"
ns_code_bin="$project_dir/NonSecure/$config/STM32H573I-DK_STiROT_Appli_TrustZone_NS_Templates.bin"
