/**
  ******************************************************************************
* @file    DCACHE/DCACHE_Maintenance/Src/hal_external_memory_helper.c
...
/**
  * @brief  This function erase one sector of the external memory and
  * return back to memory-mapped mode
  * @param  None
  * @retval 0 : if ok.
  */
uint32_t MemoryErase(uint32_t memory_offset)
{
  ...
  sCommand.Address       = memory_offset;
