...
static void OPENBL_FDCAN_Init(void)
{
  ...
  */
  ...
  hfdcan.Init.NominalPrescaler     = 0x1U;
  hfdcan.Init.NominalSyncJumpWidth = 0x10U;
  hfdcan.Init.NominalTimeSeg1      = 0x3FU;
  hfdcan.Init.NominalTimeSeg2      = 0x10U;
  hfdcan.Init.DataPrescaler        = 0x1U;
  hfdcan.Init.DataSyncJumpWidth    = 0x4U;
  hfdcan.Init.DataTimeSeg1         = 0xFU;
  hfdcan.Init.DataTimeSeg2         = 0x4U;
