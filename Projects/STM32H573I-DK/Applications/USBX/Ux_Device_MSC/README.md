...
When plugged to PC host, the STM32H573I-DK should enumerate as an USB MSC device. During the enumeration phase, device must provide host with the requested
...
Once the STM32H573I-DK USB device successfully completed the enumeration phase, a new removable drive appears in the system window and write/read/format
...
RTOS, ThreadX, USBXDevice, USBPD, Device, USB_DRD, Full Speed, MSC, Mass Storage, SD Card, DMA, SDMMC
...
- STM32H573I-DK Set-up
	...
	- Connect the STM32H573I-DK board CN17(on MB1677) to the PC through "TYPE-C" to "Standard A" cable
