...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics STM32H5732I-DK boards revision MB1677-C01
    and can be easily tailored to any other supported device and development board.

- STM32H573I-DK Set-up
    - Plug the USB MSC device into the STM32H573I-DK board through 'Type C to A-Female' cable to the connector:
       - CN17 to use USB DRD.
