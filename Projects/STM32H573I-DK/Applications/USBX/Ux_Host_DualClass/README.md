...
The application creates four threads :
  ...
  - app_ux_host_thread_entry     (Priority : 10; Preemption threshold : 10) used to initialize USB DRD HAL HCD driver, start the Host and proceed to file operations or HID reports once the device is properly enumerated.
...
When a hid device plugged to STM32H573I-DK board, a Message will be displayed on the uart HyperTerminal showing the Vendor ID and Product ID of the attached device.
...
- STM32H573I-DK Set-up
    - Plug the USB HID or MSC device into the STM32H573I-DK board through 'Type C to A-Female' cable to the connector:
    - CN17 : to use USB DRD
