...
/* AlertPower Status definition. */
#define PowerInitState    0
#define PowerRejected     1
#define PowerNotSupported 2

/* AlertRole Status definition.  */
#define RoleInitState    0
#define RoleRejected     1
#define RoleNotSupported 2
...
typedef struct
{
  ...
  uint32_t CAD_tDRP                                       :30;  /*!< The period that DRP shall complete a Source to Sink and back advertisement */
  uint32_t CAD_dcSRC_DRP                                  :30;  /*!< The percent of time that a DRP shall advertise Source during tDRP (in %) */
