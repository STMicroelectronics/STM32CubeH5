...
s_code_bin="$project_dir/Secure/$config/STM32H573I-DK_OEMiROT_Appli_TrustZone_S.bin"
ns_code_bin="$project_dir/NonSecure/$config/STM32H573I-DK_OEMiROT_Appli_TrustZone_NS.bin"
