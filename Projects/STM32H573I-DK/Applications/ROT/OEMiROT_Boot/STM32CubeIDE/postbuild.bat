...
set s_ld_file=%appli_dir%\STM32CubeIDE\STM32H573IIKXQ_FLASH.ld
set s_main="%appli_dir%\Inc\main.h"
) else (
set s_ld_file="%appli_dir%\STM32CubeIDE\Secure\STM32H573IIKXQ_FLASH.ld"
set ns_ld_file="%appli_dir%\STM32CubeIDE\NonSecure\STM32H573IIKXQ_FLASH.ld"
