...
flash_layout="$cube_fw_path/Projects/STM32H5F5J-DK/${oemirot_boot_path_project}/Inc/flash_layout.h"
...
if [ $isGeneratedByCubeMX == "false" ]; then
  if [[ ! -d "$cube_fw_path/Projects/STM32H5F5J-DK/$oemirot_appli_path_project" ]]; then
    echo "====="
