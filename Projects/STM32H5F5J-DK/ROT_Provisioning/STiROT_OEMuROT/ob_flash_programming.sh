...
remove_protect="-ob SECWM1_STRT=1 SECWM1_END=0 WRPSG11=0xffffffff WRPSG22=0xffffffff SECWM2_STRT=1 SECWM2_END=0 HDP1_STRT=1 HDP1_END=0 HDP2_STRT=1 HDP2_END=0 SWAP_BANK=0 SRAM2_RST=0 SRAM2_ECC=0 BOOT_UBE=0xB4"
erase_all="-e all"
