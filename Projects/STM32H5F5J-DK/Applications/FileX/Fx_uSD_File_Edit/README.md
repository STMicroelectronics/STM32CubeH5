...
This application provides an example of Azure RTOS FileX stack usage on STM32H5F5J-DK board, it shows how to develop a basic SD card file operations application.
...
It is possible to unplug/plug or replace the SD card without any need to reset the STM32H5F5J-DK.
