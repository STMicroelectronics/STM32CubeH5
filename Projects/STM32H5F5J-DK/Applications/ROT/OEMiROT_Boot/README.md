...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics STM32H5F5J-DK (MB)2114
...
It is needed to connect TAMP_INx (to do) and TAMP_OUTy (to do) on the STM32H5F5J-DK board,
