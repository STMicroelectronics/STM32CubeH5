...
set s_icf_file=%appli_dir%\EWARM\stm32h5f5xx_flash.icf
set s_main="%appli_dir%\Inc\main.h"
) else (
set s_icf_file="%appli_dir%\EWARM\Secure\stm32h5f5xx_flash_s.icf"
set ns_icf_file="%appli_dir%\EWARM\NonSecure\stm32h5f5xx_flash_ns.icf"
