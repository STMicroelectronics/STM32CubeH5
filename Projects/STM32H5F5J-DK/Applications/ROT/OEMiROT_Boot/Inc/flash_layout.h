...
#define OBK_HDPL2_END           (0xFFFU)        /* Last OBKey Hdpl 2 */
#define OBK_HDPL3_OFFSET        (0x1000U)        /* First OBkey Hdpl 3 */
...
#define RSS_LIB_BASE                        (0x0FFA6000U)
#define RSS_LIB_SIZE                        (0x2000U)
#define BOOTLOADER_BASE_NS                  (0x0BFAC000U)
#define BOOTLOADER_SIZE                     (0xC000U)
#define STM32_DESCRIPTOR_BASE_NS_3          (0x0BFB6000U)
#define STM32_DESCRIPTOR_BASE_NS_2          (0x0BFB6200U)
#define STM32_DESCRIPTOR_BASE_NS_1          (0x0BFB6400U)
#define RSSLIB_PFUNC_3                      (0x0BFB6068UL)
#define RSSLIB_PFUNC_2                      (0x0BFB6268UL)
#define RSSLIB_PFUNC_1                      (0x0BFB6468UL)
