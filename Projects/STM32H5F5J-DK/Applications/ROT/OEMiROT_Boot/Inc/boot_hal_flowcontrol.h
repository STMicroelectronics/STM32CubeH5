...
#if defined(MCUBOOT_EXT_LOADER)
#define FLOW_STEP_TAMP_L_EN         0x000f7214U        /*!< Step TAMP Secure enable value */
#define FLOW_STEP_TAMP_L_CH         0x00124897U        /*!< Step TAMP Secure check value */
#else
#define FLOW_STEP_TAMP_L_EN         0x00000000U        /*!< No effect on control flow */
#define FLOW_STEP_TAMP_L_CH         0x00000000U        /*!< No effect on control flow */
#endif /* MCUBOOT_EXT_LOADER && GENERATOR_TZ_AVAILABLE */
...
#define FLOW_CTRL_TAMP_L_EN         (FLOW_CTRL_NVIC_L_EN ^        FLOW_STEP_TAMP_L_EN)

#define FLOW_CTRL_HDPEXT_L_EN_B1    (FLOW_CTRL_TAMP_L_EN ^       FLOW_STEP_HDPEXT_L_EN_B1)
...
#define FLOW_CTRL_TAMP_L_CH         (FLOW_CTRL_NVIC_L_CH ^    FLOW_STEP_TAMP_L_CH)

#define FLOW_CTRL_HDPEXT_L_CH_B1    (FLOW_CTRL_TAMP_L_CH ^       FLOW_STEP_HDPEXT_L_CH_B1)
