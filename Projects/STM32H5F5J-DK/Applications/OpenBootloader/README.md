...
### <b>Hardware and Software environment</b>
  ...
  - This application runs on STM32H5F5LJ devices without security enabled (TZEN = 0).

  - This application has been tested with STM32H5F5LJ-DK-C01 (MB2114) board
    and can be easily tailored to any other supported device and development board.

  - STM32H5F5LJ-DK-C01 set-up to use USB:
    - USB HS CN13
