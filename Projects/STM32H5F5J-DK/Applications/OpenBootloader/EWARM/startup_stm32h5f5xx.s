;********************************************************************************
;* File Name          : startup_stm32h5f5xx.s
;* Author             : MCD Application Team
;* Description        : STM32H5F5xx Crypto Devices vector
...
__vector_table
        ...
        DCD     DMA2D_IRQHandler                 ; DMA2D interrupt
        DCD     JPEG_IRQHandler                  ; JPEG interrupt
        ...
        DCD     GPDMA2_Channel8_IRQHandler       ; GPDMA2 channel 8 global interrupt
        DCD     GPDMA2_Channel9_IRQHandler       ; GPDMA2 channel 9 global interrupt
        DCD     GPDMA2_Channel10_IRQHandler      ; GPDMA2 channel 10 global interrupt
        DCD     GPDMA2_Channel11_IRQHandler      ; GPDMA2 channel 11 global interrupt
        DCD     GFXTIM_IRQHandler                ; GFXTIM interrupt
        DCD     LCD_IRQ_IRQHandler               ; LCD global interrupt
        DCD     LCD_GBL_ERROR_IRQHandler         ; LCD global error interrupt
        ...
        DCD     OTFDEC2_IRQHandler               ; OTFDEC2 secure global interrupt
        DCD     FDCAN3_IT0_IRQHandler            ; FDCAN3 Interrupt 0
        DCD     FDCAN3_IT1_IRQHandler            ; FDCAN3_IT1  interrupt
        DCD     MDF1_FLT0_IRQHandler             ; MDF1_FLT0 global interrupt
        DCD     MDF1_FLT1_IRQHandler             ; MDF1_FLT1 global interrupt
        DCD     MDF1_FLT2_IRQHandler             ; MDF1_FLT2 global interrupt
        DCD     MDF1_FLT3_IRQHandler             ; MDF1_FLT3 global interrupt
        DCD     MDF1_FLT4_IRQHandler             ; MDF1_FLT4 global interrupt
        DCD     MDF1_FLT5_IRQHandler             ; MDF1_FLT5 global interrupt
        DCD     ADF1_FLT0_IRQHandler             ; ADF1_FLT0 global interrupt
...
GPDMA1_Channel11_IRQHandler
        ...
        PUBWEAK GPDMA2_Channel8_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
GPDMA2_Channel8_IRQHandler
        B GPDMA2_Channel8_IRQHandler	

        PUBWEAK GPDMA2_Channel9_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
GPDMA2_Channel9_IRQHandler
        B GPDMA2_Channel9_IRQHandler	

        PUBWEAK GPDMA2_Channel10_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
GPDMA2_Channel10_IRQHandler
        B GPDMA2_Channel10_IRQHandler	

        PUBWEAK GPDMA2_Channel11_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
GPDMA2_Channel11_IRQHandler
        B GPDMA2_Channel11_IRQHandler	
...
GFXTIM_IRQHandler
        ...
        PUBWEAK LCD_IRQ_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LCD_IRQ_IRQHandler
        B LCD_IRQ_IRQHandler

        PUBWEAK LCD_GBL_ERROR_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LCD_GBL_ERROR_IRQHandler
        B LCD_GBL_ERROR_IRQHandler

        PUBWEAK PLAY1_NS_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
PLAY1_NS_IRQHandler
        B PLAY1_NS_IRQHandler
