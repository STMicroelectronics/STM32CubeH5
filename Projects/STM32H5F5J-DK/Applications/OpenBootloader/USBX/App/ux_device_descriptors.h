...
#define USBD_DFU_STRING_OB1_DESC_INDEX                 0x07U
#define USBD_DFU_STRING_OB1_DESC                       "@Option Bytes   /0x40022050/01*176 e"

#define USBD_DFU_STRING_OB2_DESC_INDEX                 0x08U
#define USBD_DFU_STRING_OB2_DESC                       "@Option Bytes   /0x400221E0/01*32 e"

#define USBD_DFU_STRING_OTP_DESC_INDEX                 0x09U
#define USBD_DFU_STRING_OTP_DESC                       "@OTP Memory   /0x08FFF000/02*01Kg"

#define USBD_DFU_STRING_DEVICE_ID_DESC_INDEX           0x14U
#define USBD_DFU_STRING_DEVICE_ID_DESC                 "@Device ID/0x47A,@Revision ID/0x0001"
