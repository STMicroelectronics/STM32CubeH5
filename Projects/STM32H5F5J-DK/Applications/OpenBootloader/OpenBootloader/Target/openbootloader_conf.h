...
#define DEVICE_ID_LSB                     0x47U  /* LSB byte of device ID */
...
#define RAM_SIZE                          (1536U * 1024U)                 /* Size of RAM 1536 kByte */
...
#define OB2_START_ADDRESS                 (OB_START_ADDRESS + 0x140U)     /* Option Bytes 2 start address */
...
#define ICP_SIZE                          (48U * 1024U)                   /* Size of ICP 48 kByte */
#define ICP_START_ADDRESS                 0x0BFAC000U                     /* System memory start address */
#define ICP_END_ADDRESS                   (ICP_START_ADDRESS + ICP_SIZE)  /* System memory end address */

#define EB_SIZE                           (1U * 1024U)                    /* Size of Engi bytes 1 kByte */
...
#define OPENBL_RAM_SIZE                   0x8C00U              /* RAM used by the Open Bootloader 35 kBytes */
