...
When a USB flash disk is plugged to STM32H5F5J-DK board, a message will be displayed on the UART HyperTerminal showing the Vendor ID and the Product ID of the attached device.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics STM32H5F5J-DK boards revision: MB2114-B01
    and can be easily tailored to any other supported device and development board.
  - STM32H5F5J-DK set-up:
    - Plug the USB key into the STM32H5F5J-DK board through 'Type C to A-Female' cable to the connector:
