...
When a hid device is plugged to STM32H5F5J-DK board, a Message will be displayed on the uart HyperTerminal showing
...
- STM32H5F5J-DK Set-up
    - Plug the USB HID device into the STM32H5F5J-DK board through 'Type C  to A-Female' cable to the connector:
