...
The **AppTCPThread**, once started:
  ...
  + At each message sent, the <i>TCP</i> client reads the server response and prints it on the hyper-terminal and the green led is toggled.
...
In order to make the program work, you must do the following :
 ...
 - Edit the file <code> NetXDuo/App/app_netxduo.h</code> and correctly define the <i>TCP_SERVER_ADDRESS</i> and <i>TCP_SERVER_PORT</i> to connect on.
