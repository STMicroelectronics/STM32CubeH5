...
This project is targeted to run on STM32H5F5xx devices on STM32H5F5J-DK boards from STMicroelectronics.  
...
file is as follows:
     ...
     - TZEN=B4 
     - SECWM1_STRT=0x0  SECWM1_END=0xFF  meaning all 256 sectors of Bank1 set as secure
...
This project is targeted to run on STM32H5F5xx device on STM32H5F5J-DK boards from STMicroelectronics.  
...
### <b>Directory contents</b>
      ...
      - Templates/TrustZoneEnabled/Secure/Inc/partition_stm32h5f5xx.h        STM32H5 Device System Configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32H5F5xx devices with security enabled (TZEN=B4).  
  - This template has been tested with STMicroelectronics STM32H5F5J-DK (MB2114)
  ...
  - User Option Bytes requirement (with STM32CubeProgrammer tool)
        ...
        - SECWM1_STRT=0x0  SECWM1_END=0xFF    All 256 sectors of internal Flash Bank1 set as secure
...
<b>IAR</b>
 ...
 - After that follow User Option Bytes configuration above
 - Run the example
