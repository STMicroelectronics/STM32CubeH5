...
The STM32H5F5J-DK board LEDs can be used to monitor the transfer status:  
...
### <b>Directory contents</b>
        ...
        - FLASH/FLASH_EraseProgram/Inc/stm32h5f5j_discovery_conf.h   BSP configuration file
