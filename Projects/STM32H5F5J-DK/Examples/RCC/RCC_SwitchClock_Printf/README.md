## <b>RCC_SwitchClock_Printf Example Description</b>
...
HSI as clock source, the USER push-button (connected to External line 8) will be
...
Each time the USER push-button is pressed External line 8 interrupt is generated and in the ISR
...
- If the HSE oscillator is selected as PLL source, the following steps will be followed to switch
   the PLL source to CSI oscillator:
     ...
     e. Print a message indicating the clock source switch
...
### <b>Directory contents</b>
    ...
    - RCC/RCC_SwitchClock_Printf/Inc/stm32h5f5i_discovery_conf.h   BSP configuration file
    - RCC/RCC_SwitchClock_Printf/Inc/stm32h5xx_hal_conf.h          HAL configuration file
    - RCC/RCC_SwitchClock_Printf/Inc/stm32h5xx_it.h                Interrupt handlers header file
    - RCC/RCC_SwitchClock_Printf/Inc/main.h                        Header for main.c module
    - RCC/RCC_SwitchClock_Printf/Src/stm32h5xx_it.c                Interrupt handlers
    - RCC/RCC_SwitchClock_Printf/Src/main.c                        Main program
    - RCC/RCC_SwitchClock_Printf/Src/system_stm32h5xx.c            STM32H5xx system source file
    - RCC/RCC_SwitchClock_Printf/Src/stm32h5xx_hal_msp.c           HAL MSP module

### <b>Hardware and Software environment</b>

  - This example runs on STM32H5F5LJHxQ devices.

  - This example has been tested with STM32H5F5J-DK
