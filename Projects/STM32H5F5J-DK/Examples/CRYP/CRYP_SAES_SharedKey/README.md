...
In this example, LED3 (led GREEN) is turned on when the operation finish with success . 
and LED1 (led RED) is turned on when the operation generate an error.
...
### <b>Directory contents</b>
  ...
  - CRYP/CRYP_SAES_SharedKey/Inc/stm32h5f5j_discovery_conf.h    BSP configuration file
