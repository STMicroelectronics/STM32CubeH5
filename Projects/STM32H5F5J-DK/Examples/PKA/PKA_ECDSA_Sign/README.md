...
In case of success, the LED1 (RED) is ON.
In case of any error, the LED1 (RED) is toggling slowly.
...
### <b>Hardware and Software environment</b> 
  ...
  - This example has been tested with an STMicroelectronics STM32H5F5J-DK
