...
/* Start @ of user data trimming area */
#define USER_DATA_TRIM_START_ADDR   (0x08FFF800UL)

/* End @ of of user data trimming area */
#define USER_DATA_TRIM_END_ADDR     (0x08FFFFFFUL)
...
int main(void)
{
  ...
  */
  ...
  if (BSP_COM_Init(COM2, &BspCOMInit) != BSP_ERROR_NONE)
  {
    Error_Handler();
  }
  printf("ADC MultiChannel_SingleConversion Readings !\r\n");
  ...
  while (1)
  {
    ...
    if(ubDmaTransferStatus == 1)
    {
      ...
      printf("the value of ADC Conversion of VoltageGpio in mVolt: %dmv\r\n", uhADCxConvertedData_VoltageGPIO_mVolt);
      printf("the value of ADC Conversion of VrefInt in mVolt: %dmv\r\n", uhADCxConvertedData_VrefInt_mVolt);
      printf("the value of ADC Conversion of TemperatureSensor in degree celsius : %d C\r\n", hADCxConvertedData_Temperature_DegreeCelsius);
...
static void MPU_Config(void)
{
  ...
  region.BaseAddress      = USER_DATA_TRIM_START_ADDR;
  region.LimitAddress     = USER_DATA_TRIM_END_ADDR;
