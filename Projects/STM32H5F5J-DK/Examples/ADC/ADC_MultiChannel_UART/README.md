## <b>ADC_MultiChannel_UART Example Description</b>
...
It will print out the converted values on UART terminal.
...
LED3(LED_GREEN) is used to monitor program execution status:
...
- Error: LED1(LED_RED) remaining turned on
...
Other peripherals used:
  ...
  1 GPIO for LED1(LED_RED)
  1 GPIO for LED3(LED_GREEN)

  1 GPIO for analog input: ADC channel 0 on pin PA.0 (Connector CN9 pin 1)

  1 DMA channel

#### <b>Notes</b>

  - For STM32CubeIDE the project works well only with a _Min_Stack_Size = 0x420.

### <b>Keywords</b>

ADC, analog digital converter, analog, conversion, voltage, channel, analog input, DMA transfer, sequence, temperature sensor, internal voltage reference, VrefInt, discontinuous, UART

### <b>Directory contents</b>

    - ADC/ADC_MultiChannel_UART/Inc/stm32h5f5j_discovery_conf.h     BSP configuration file
    - ADC/ADC_MultiChannel_UART/Inc/stm32h5xx_hal_conf.h            HAL configuration file
    - ADC/ADC_MultiChannel_UART/Inc/stm32h5xx_it.h                  Interrupt handlers header file
    - ADC/ADC_MultiChannel_UART/Inc/main.h                          Header for main.c module
    - ADC/ADC_MultiChannel_UART/Src/stm32h5xx_it.c                  Interrupt handlers
    - ADC/ADC_MultiChannel_UART/Src/stm32h5xx_hal_msp.c             HAL MSP module
    - ADC/ADC_MultiChannel_UART/Src/main.c                          Main program
    - ADC/ADC_MultiChannel_UART/Src/system_stm32h5xx.c              STM32H5xx system source file
