...
int main(void)
{
  ...
  UTIL_LCD_DisplayStringAt(0, 30, (uint8_t *)"DMA2D_MemToMemWithPFC example", CENTER_MODE);
  ...
  while (1)
  {
    ...
    hal_status =  HAL_DMA2D_Start_IT(&hdma2d,
                         (uint32_t)&RGB565_240x130_2,                                       /* Source buffer in format RGB565 and size 320x240      */
...
static void MX_DMA2D_Init(void)
{
  ...
  hdma2d.Init.OutputOffset = LCD_X_Size - IMAGE_SIZE_X;
