...
The SystemClock_Config() function is used to configure the system clock for STM32H5F5LJHxQ Devices :
The CPU at 250 MHz.
...
STM32H5F5J-DK board's LEDs can be used to monitor the transfer status:
 ...
 - LED3  is ON when write/read transfer is ongoing.
 - LED3 is Toggling  when write and read transfer is completed and check buffers are OK.
 - LED1 is Toggling  when there is an error in transfer process or initialization.
...
### <b>Directory contents</b>
  ...
  - SD/SD_ReadWrite_DMALinkedList/Inc/stm32h5f5j_discovery_conf.h     HAL configuration file
...
### <b>Hardware and Software environment</b>
  ...
  - Connect the uSD Card to the Micro SD connector (CN10).
...
In order to make the program work, you must do the following :
 ...
 - Plug the SD Card in the STM32H5F5J-DK
 - Run the example
